    ...
    render() {
        return (
            ...
            <div className="bg3">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <img className="Food" src="/images/Food.png" style={{position: 'absolute', zIndex: '1', width: '350px', height: '250px', marginTop: '225px',marginLeft: '600px'}}/>
            ...
            <div className="container-fluid">
                <div className="row">
                    <div className="col-md-6">
                    <img className="Digg" src="/images/Digg.png" style={{position: 'absolute', zIndex: '1', width: '350px', height: '250px', marginTop: '225px',marginLeft: '575px'}}/>
                        <Text style={{ position: 'absolute', zIndex: '0', marginTop: '550px', marginLeft: '100px' }}>
